 ...
 */
public class OrderedArrayList<E extends Comparable<E>>
    ...
    implements OrderedStructure<E>
{
    ...
    /**
     * 
     * @param target - element searching for
     * @return
     * 		if target is in list, return index for it.  If it is not in
     * 		the list then return slot where would add it.
     * 		Thus have only found target if data[returnIndex] == target
     */
